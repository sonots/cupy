...
class TestSingleDeviceMemoryPool(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.stream_ref = weakref.ref(self.stream)
    ...
    def test_split(self):
        ...
        chunk = memory.Chunk(mem, 0, mem.size, self.stream_ref)
        ...
        self.assertEqual(head.stream_ref, self.stream_ref)
        ...
        self.assertEqual(tail.stream_ref, self.stream_ref)
        ...
        self.assertEqual(head_of_head.stream_ref, self.stream_ref)
        ...
        self.assertEqual(tail_of_head.stream_ref, self.stream_ref)
        ...
        self.assertEqual(head_of_tail.stream_ref, self.stream_ref)
        ...
        self.assertEqual(tail_of_tail.stream_ref, self.stream_ref)
    ...
    def test_merge(self):
        ...
        self.assertEqual(merged_head.stream_ref, self.stream_ref)
        ...
        self.assertEqual(merged_tail.stream_ref, self.stream_ref)
        ...
        self.assertEqual(merged.stream_ref, self.stream_ref)
