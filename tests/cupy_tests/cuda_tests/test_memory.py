...
class TestSingleDeviceMemoryPool(unittest.TestCase):
    ...
    def test_split(self):
        ...
        chunk = memory.Chunk(mem, 0, mem.size, self.stream)
        ...
        self.assertEqual(head.stream,   self.stream)
        ...
        self.assertEqual(tail.stream,   self.stream)
        ...
        self.assertEqual(head_of_head.stream,   self.stream)
        ...
        self.assertEqual(tail_of_head.stream,   self.stream)
        ...
        self.assertEqual(head_of_tail.stream,   self.stream)
        ...
        self.assertEqual(tail_of_tail.stream,   self.stream)
    ...
    def test_merge(self):
        ...
        self.assertEqual(merged_head.stream,   self.stream)
        ...
        self.assertEqual(merged_tail.stream,   self.stream)
        ...
        self.assertEqual(merged.stream, self.stream)
