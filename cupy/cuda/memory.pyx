...
cdef class Chunk:
    ...
    def __init__(self, mem,
                 Py_ssize_t offset,
                 Py_ssize_t size,
                 stream=stream_module.Stream.null):
...
cdef class SingleDeviceMemoryPool:
    ...
    cpdef list _arena(self, stream=stream_module.Stream.null):
        return self._free[stream]

    cpdef list _free_list(self, Py_ssize_t index,
                          stream=stream_module.Stream.null):
    ...
    cpdef MemoryPointer malloc(self, Py_ssize_t size):
        ...
        stream = stream_module.get_currentstream_module()
